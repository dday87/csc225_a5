...
public class Graph<T> implements GraphADT<T>
{
    ...
    {
        int temp1 = getIndex(vertex1);
        int temp2 = getIndex(vertex2);
        	removeEdge(temp1, temp2);
    ...
    public void removeVertex(int index)
    {
        ...
        // Shifts vertices down the array
        for(int i = index; i < vertices.length;i++)
        {
        	while(vertices[index+1] != null)
        	{
        		T temp1 = vertices[index+1];
        		vertices[index] = temp1;
        	}	
    ...
    /**
     * Uses an iterator to visit every 
     * every vertex in the graph
     */
	public boolean isConnected() 
	{
		int index = 0;
		Iterator<T> myIterator = iteratorDFS(index);
		return false;
	}
    ...
    {
    	if(adjMatrix[index1][index2] == true)
    	{
    		return true;
    	}
